...
public class EmpioyeeDAOImpl implements employeeDAO {
    //connect database
    ...
    private static EmpioyeeDAOImpl instant = new EmpioyeeDAOImpl();

    public static EmpioyeeDAOImpl getInstance() {
        return instant;
    }
    ...
    public void deleteEmp(int id) {
        ...
        try {
            ...
            int rs = ps.executeUpdate();
            if (rs != 0) {
                System.out.println("Employee wiht empID"
                        + id + "was delete.");
            } else {
    ...
    public Employee findEmp(int id) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                System.out.println("Clocd not found Employee" +
                        "with empID" + id);
            }
            rs.close();
            ps.close();
